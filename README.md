# Available .REST One-Word Domains (5,621,968)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-9%2C236%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-5%2C621%2C968%20domains-6f42c1">
...
> **Important:** this repository is a **public 9,236-row extract**, not the full live catalog.
> The full live catalog for this exact search currently contains **5,621,968 domains** on the canonical page below.

**Public extract:** 9,236 rows · **Live catalog:** 5,621,968 domains
...
<p align="center">
  ...
  <a href="https://unique.domains/domains/tld/rest?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_rest_oneword_domains&utm_content=top_create_radar"><b>🔔 Create Radar</b></a> ·
  <a href="https://unique.domains/domains/tld/rest?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_rest_oneword_domains&utm_content=top_start_project"><b>🚀 Start a Project</b></a> ·
  <b>⬇️ Download sample</b>: <a href="./rest.csv">CSV</a> / <a href="./rest.json">JSON</a>
</p>

<p align="center">
  <a href="https://unique.domains/technology?utm_source=github&utm_medium=referral&utm_campaign=repo_rest_oneword_domains&utm_content=top_methodology">Methodology</a> ·
  <a href="https://unique.domains/api?utm_source=github&utm_medium=referral&utm_campaign=repo_rest_oneword_domains&utm_content=top_api_docs">API docs</a>
</p>
...
- **Investors:** [Create a Radar from this exact .REST search](https://unique.domains/domains/tld/rest?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_rest_oneword_domains&utm_content=top_create_radar)
- **Founders:** [Start a Project from this exact .REST search](https://unique.domains/domains/tld/rest?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_rest_oneword_domains&utm_content=top_start_project)
- **Researchers / builders:** [Download CSV](./rest.csv) or [Download JSON](./rest.json)
...
- `rest.csv` — public CSV extract (9,236 rows)
- `rest.json` — public JSON extract (9,236 rows)
...
| ----------------------- | ------------------------------------------------ |
| 9,236-row public sample | 5,621,968 live domains                           |
...
| jesus.rest      | resell    | —         | —             | 126            | 53     | 5      | Dynadot, LLC    |
| data.rest       | premium   | $1,462.50 | $2,925        | 70             | 60     | 4      | namecheap       |
| conscious.rest  | available | $41.98    | —             | 89             | 37     | 9      | namecheap       |
| fortune.rest    | resell    | —         | —             | 72             | 53     | 7      | Dynadot, LLC    |
| ace.rest        | premium   | $819      | $1,170        | 88             | 57     | 3      | namecheap       |
| rank.rest       | available | $41.98    | —             | 70             | 35     | 4      | namecheap       |
| root.rest       | resell    | —         | —             | 64             | 50     | 4      | Spaceship, Inc. |
| live.rest       | premium   | $4,095    | $5,850        | 108            | 55     | 4      | namecheap       |
...
> Unique Domains. *Available .REST One-Word Domains*. Version 2026-04-09. Public GitHub extract for the exact Unique Domains search represented by this repository.
