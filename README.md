# Available .REST One-Word Domains (27,163)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-1%2C000%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-27%2C163%20domains-6f42c1">
...
> The full live catalog for this exact search currently contains **27,163 domains** on the canonical page below.

**Public extract:** 1,000 rows · **Live catalog:** 27,163 domains · **Median ask:** $35.07 · **High-demand under $2,500:** 20
...
| rich.rest    | resell    | —         | —             | medium         | low    | 4      | Spaceship, Inc.                     |
...
| ----------------------- | ------------------------------------------ |
| 1,000-row public sample | 27,163 live domains                        |
...
> Unique Domains. *Available .REST One-Word Domains*. Version 2026-09-18. Public GitHub extract for the exact Unique Domains search represented by this repository.
